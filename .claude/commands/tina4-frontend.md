...
3. Build output goes to `public/` -- Tina4 serves it automatically
...
Tina4::Router.get "/*path" do |path, request, response|
  response.html(File.read("src/public/index.html"))
end
```
