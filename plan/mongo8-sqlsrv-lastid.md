...
## Commits (tina4-ruby, branch fix/mongo8-sqlsrv-lastid)
- e928996  Spec runs never open a browser: default TINA4_NO_BROWSER=true
- 51e6532  Lock in replica-set BSON decoding; CI runs Mongo 8 as a replica set
